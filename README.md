...
| <a name="input_enable_termination_protection"></a> [enable\_termination\_protection](#input\_enable\_termination\_protection) | (optional) If true, enables EC2 Instance Termination Protection. | `bool` | `true` | no |
